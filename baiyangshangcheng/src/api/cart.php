...
if($type == "add")
{
  ...
  if(mysqli_num_rows($result) == 0)
  {
    ...
    $sql = "INSERT INTO `cart` (`id`, `good_id`,`cart_id`, `num`) VALUES ($id,$good_id, NULL, 1)";
  }else{
    /* 更新数据 */
  ...
  $sql = "SELECT cart.*,goodlist.title,goodlist.g1,goodlist.store,goodlist.priceA FROM cart , goodlist WHERE cart.good_id = goodlist.good_id AND id=$id";
